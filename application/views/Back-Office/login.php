...
<head>
  ...
  <title>Authentification - InformationArticle</title>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="<?php echo site_url('Front-Office/SController/home');?>" class="logo d-flex align-items-center w-auto">
                  <img src="<?php echo site_url('assets/img/logo.png');?>" alt="">
                  <span class="d-none d-lg-block">InformationArticle</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="<?php echo site_url('Back-Office/SController/authentification');?>" method="post">

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Username</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="email" name="username" class="form-control" id="yourUsername" value="admin@admin" required>
                    ...
                    <div class="col-12">
                      <center><p class="small mb-0">Don't have account? <a href="pages-register.html">Create an account</a></p></center>
                    </div>
                    </br>
                  </form>
